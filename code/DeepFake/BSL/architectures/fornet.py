...
class EfficientNetGen(FeatureExtractor):
    def __init__(self, model: str, num_class=1):
        super(EfficientNetGen, self).__init__()

        self.efficientnet = EfficientNet.from_name(model)
        self.classifier = nn.Linear(self.efficientnet._conv_head.out_channels, num_class)
...
class EfficientNetB3(EfficientNetGen):
    def __init__(self):
        super(EfficientNetB3, self).__init__(model='efficientnet-b3')
